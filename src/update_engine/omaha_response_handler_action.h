...
public:
    ...
    bool GotNoUpdateResponse() const
    {
        return got_no_update_response_;
    }
    const InstallPlan &install_plan() const
    {
    ...
    {
        return "OmahaResponseHandlerAction";
    }
...
private:
    ...
    // E.g., /dev/sda4 -> /boot/remarkable/vmlinuz-a
