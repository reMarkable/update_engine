...
public:
    ...
    inline std::string os_platform() const
    {
        return os_platform_;
    }
    inline std::string os_version() const
    {
        return os_version_;
    }
    inline std::string os_sp() const
    {
        return os_sp_;
    }
    inline std::string os_board() const
    {
        return os_board_;
    }
    inline std::string app_id() const
    {
        return app_id_;
    }
    inline std::string app_lang() const
    {
        return app_lang_;
    }
    inline std::string hwid() const
    {
        return hwid_;
    }
    inline std::string bootid() const
    {
        return bootid_;
    }
    inline std::string machineid() const
    {
        return machineid_;
    }
    inline std::string oemid() const
    {
        return oemid_;
    }
    inline std::string oemversion() const
    {
        return oemversion_;
    }
    inline std::string alephversion() const
    {
        return alephversion_;
    }
    inline std::string arch() const
    {
        return arch_;
    }
    inline std::string session_uuid() const
    {
    ...
    inline std::string app_version() const
    {
        return app_version_;
    }
    inline std::string app_channel() const
    {
        return app_channel_;
    }

    // Can client accept a delta ?
    inline void set_delta_okay(bool ok)
    {
        delta_okay_ = ok;
    }
    inline bool delta_okay() const
    {
        return delta_okay_;
    }
    ...
    inline void set_update_url(const std::string &url)
    {
        update_url_ = url;
    }
    inline std::string update_url() const
    {
        return update_url_;
    }
